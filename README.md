...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r1btbpg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r1btbpg.containers.anotherwebservice.com/
...
```
git clone git@github.com:Estrategasdelviejocontinente/container-r1btbpg.git
cd container-r1btbpg
```
...
```
docker attach container-r1btbpg
```
